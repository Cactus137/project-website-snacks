    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="?action=tables&data=dashboard">Pages</a></li>
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><?php echo ucfirst($_GET['data']); ?></li>
            ...
            <ul class="navbar-nav justify-content-end">
                ...
                <li class="nav-item dropdown mx-3">
                    <a class="nav-link dropdown-toggle" href="#" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <img class="img-profile rounded-circle" src="assets/img/team-2.jpg" width="30px">
                    </a>
