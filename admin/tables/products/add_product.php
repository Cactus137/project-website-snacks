                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-4 d-flex align-items-center">
                                        <div class="form-outline w-100">
                                            ...
                                            <input type="number" id="quantityS" name="quantityS" value="" placeholder="" class="form-control form-control-sm" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-4 d-flex align-items-center">
                                        <div class="form-outline w-100">
                                            ...
                                            <input type="number" id="quantityM" name="quantityM" value="" placeholder="" class="form-control form-control-sm" />
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-4 d-flex align-items-center">
                                        <div class="form-outline w-100">
                                            ...
                                            <input type="number" id="quantityL" name="quantityL" value="" placeholder="" class="form-control form-control-sm" />
                                        </div>
                                    </div>
